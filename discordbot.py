...
def bukkeneki(b):
    ...
    for i in range(len(aa)):
        if b == aa[i][0]:
            ans = ans + aa[i][0] + '独占購入額' + str(aa[i][1]) + '万円 独占時収益' + str(aa[i][2]) + '万円'
    return ans
...
bb=[ ['士別', '徳政令', 'おはらい', 'うんちの壁', 'うんち突入', 'ぶっとび', '新幹線周遊', '特急周遊'], 
    ['浦河', '豪速球', '乗っ取り放題', '強奪飛び周遊', 'スペシャル', '物件飛び', 'のぞみ周遊', '新幹線周遊', '特急周遊'], 
    ['弟子屈', '最下位', 'バキューム', '徳政令', 'お殿様', 'ブックマーク', '足踏み', '特急周遊'], 
    ['知床', '乗っ取り放題', 'パト', 'シュレッダー', 'テレポート', '☆飛び周遊', 'のぞみ周遊'], 
    ['岩見沢', '福袋', '期間延長', '徳政令', 'おはらい', '新幹線周 遊', 'のぞみ'], 
     ['宮古', '乗っ取り放題', '徳政令', 'スペシャル', '物件飛び周遊', 'ロイヤルEX', '新幹線周遊'], 
     ['恐山', '徳政令', 'おはらい', '足踏み', 'ぶっとび', '新幹線周遊', '特急周遊', 'リニア'], 
     ['新庄', '徳政令', 'おはらい', '足踏み', 'ぶっとび', '新幹線周遊', '特急周遊', 'リニア'], 
      ['三宅島', '絶好調崩し', '武器よさらば', '最果て', '刀狩り', 'ぴったり', '牛歩', 'お役ごめん', '孤軍奮闘'], 
      ['大網', '刀狩り', '徳政令', '里帰り', '☆飛び周遊', '北へ！', '新幹線周遊', '特急周遊'],
      ['日光', '徳政令', 'おはらい', '足踏み', 'ぶっとび', '新幹線周遊', '特急周遊', 'リニア'], 
      ['高輪ゲートウェイ', 'カードバンク', 'パト', 'スペシャルズ', '物件飛び周遊', 'リニア周遊', 'ロイヤルEX', 'のぞみ周遊'],
      ['八尾', ' 徳政令', 'イエロー', 'シュレッダー', '北へ！', 'ぶっとび周遊', '新幹線周遊', '特急周遊', '新幹線'],
       ['佐久間', '６大都市', 'スペシャルズ', '物件飛び周遊', '物件飛び', 'のぞみ周遊', '新幹線周遊', 'リニア', 'のぞみ'], 
       ['珠洲', 'オナラ', 'うんちの壁', 'もれちゃうぞ', 'ばちあたり', '指定うんち！', 'うんち', 'のぞみ'], 
    ['大月', '徳政令', 'おはらい', '足踏み', 'ぶっとび', '新幹線周遊', '特急周遊', 'リニア'], 
    ['木曽', '徳政令', 'おはらい', '足踏み', 'ぶっとび', '新幹線周遊', '特急周遊', 'リニア'],
    ['マキノ', '徳政令', 'イエロー', 'シュレッダー', '北へ！', 'ぶっとび周遊', '新幹線周遊', '特急周遊', '新幹線'],
    ['綾部', '刀狩り', '徳政令', '里帰り', '☆飛び周遊', '北へ！', '新幹線周遊', '特急周遊'], 
    ['尾鷲', ' オナラ', 'うんちの壁', 'もれちゃうぞ', 'ばちあたり', '指定うんち！', 'うんち', 'のぞみ'], 
['益田', '徳政令', 'おはらい', '足踏み', 'ぶっとび', '新幹線周遊', '特急周遊', 'リニア'], 
['新居浜', '６大都市', 'スペシャルズ', 'スペシャル', 'おはらい', '☆飛び周遊', '物件飛び周遊', 'のぞみ周遊', 'のぞみ'], 
 ['中村', '徳政令', 'おはらい', '足踏み', 'ぶっとび', '新幹線周遊', '特急周遊', 'リニア'], 
 ['牛深', '徳政令', 'イエロー', 'シュレッダー', '北へ！', 'ぶっとび周遊', '新幹線周 遊', '特急周遊', '新幹線'], 
  ['高千穂', '６大都市', 'スペシャルズ', 'スペシャル', 'おはらい', '☆飛び周遊', '物件飛び周遊', 'のぞみ周遊', 'のぞみ'], 
  ['日向', '最下位', 'バキューム', '徳政令', 'お殿様', 'ブックマーク', '足踏み', '特急周遊'], 
  ['指宿', '刀狩り', '徳政令', '里帰り', '☆飛び周遊', '北へ！', '新幹線周遊', '特急周遊'], 
  ['佐多', 'カードバンク', 'パト', '地方へ！', '期間延長', '徳政令', '物件飛び'], 
  ['糸満', '徳政令', 'イエロー', 'シュレッダー', '北へ！', 'ぶっとび周遊', '新幹線周遊', '特急周遊', '新幹線'], 
   ['赤嶺', '豪速球', '乗っ取り放題', '強奪飛び周遊', 'スペシャル', '物件飛び', 'のぞみ周遊', '新幹線周遊', '特急周遊'], 
   ['飫肥', '徳政令', 'おはらい', '足踏み', 'ぶっとび', '新幹線周遊', '特急周遊', 'リニア']]
        ...
        for j in range (len(bb[i])):
            if a == bb[i][j]:
                if j == 0:
                    ...
                    ans.append(bb[i][0])
    if ans == []:
        ans = ['ないっぽい。データミスなら報告してね。']
    return ans

@bot.command()
async def csa(ctx,arg):
    await ctx.send(searchadv(arg))
